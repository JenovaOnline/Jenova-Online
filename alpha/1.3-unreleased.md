...
{% hint style="warning" %}
**NOTE** _Change-log is incomplete. These notes may change at anytime_
{% endhint %}

{% hint style="danger" %}
**WARNING** _Please start a new game on each update or some functions may not work!_
{% endhint %}

{% hint style="danger" %}
**Critical Update!** **Please update the launcher to get this update!**
{% endhint %}
...
* Harold Base Class passive now increases bleed chance by 6%
